...
if __name__ == '__main__':
    ...
    command_part_1 = f"{absdir}/train-saturn.py --in_data={args.run} --device_num="
    
    command_part_2 = f" --in_label_col={args.in_label_col} --ref_label_col={args.ref_label_col} --work_dir=./Vignettes/multiple_seeds_results/ --num_macrogenes={args.macrogenes} --pretrain --model_dim=256 --polling_freq=201 --epochs=50 --pretrain_epochs=200 --pe_sim_penalty={args.pe_sim_penalty} --l1_penalty={args.l1_penalty} --seed="
